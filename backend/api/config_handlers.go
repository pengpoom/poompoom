...
func (s *Server) handleUpdateConfig(w http.ResponseWriter, r *http.Request) {
	...
	overrides := map[string]map[string]any{
		...
		"api_access": {
			"platform": payload.APIAccess.Platform,
			"base_url": payload.APIAccess.BaseURL,
			"api_key":  payload.APIAccess.APIKey,
		},
		"newapi": {
...
func (s *Server) buildConfigPayloadFromConfig(cfg *config.Config) configPayload {
	...
	payload.APIAccess.Platform = cfg.APIAccess.Platform
	payload.APIAccess.BaseURL = cfg.APIAccess.BaseURL
	payload.APIAccess.APIKey = cfg.APIAccess.APIKey
