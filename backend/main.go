...
func main() {
	...
	logger.Info("image-studio listening", slog.String("addr", addr))
...
func applyEnvConfigOverrides(cfg *config.Config) error {
	...
	putString("API_ACCESS_PLATFORM", "api_access", "platform")
	putString("API_ACCESS_BASE_URL", "api_access", "base_url")
	putString("API_ACCESS_API_KEY", "api_access", "api_key")
